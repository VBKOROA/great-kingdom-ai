...
echo "  great-kingdom-actor-v2 --actor-config configs/runpod/actor-v2.yaml --loop --sleep-seconds 1"
echo "  great-kingdom-learner-v2 --learner-config configs/runpod/learner-v2.yaml --train-config configs/runpod/train.yaml --loop --sleep-seconds 5"
