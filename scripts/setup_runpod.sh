...
echo "For async v2 training, run actor and learner in separate terminals:"
echo "  great-kingdom-actor-v2 --actor-config configs/runpod/actor-v2.json --loop --sleep-seconds 1"
echo "  great-kingdom-learner-v2 --learner-config configs/runpod/learner-v2.json --train-config configs/runpod/train.json --loop --sleep-seconds 5"
