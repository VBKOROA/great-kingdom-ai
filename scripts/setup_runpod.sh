...
echo "  great-kingdom-rust-onnx-pipeline --device cuda --pipeline-config configs/runpod/pure-gumbel-budget-pipeline.json --train-config configs/runpod/pure-gumbel-minibatch-train.json --arena-config configs/runpod/pure-gumbel-budget-arena.json"
