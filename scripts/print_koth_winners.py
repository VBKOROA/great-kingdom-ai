"""Print KOTH summary winners in match order."""
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Print winners from a find_strongest_candidate.py summary.json file."
    )
...
def main() -> NoReturn:
    ...
    winners = extract_winners(summary, include_initial_champion=args.include_initial_champion)
